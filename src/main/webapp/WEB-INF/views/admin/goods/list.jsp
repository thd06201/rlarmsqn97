					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="/admin/goods/register">일반 상품</a> <a
									class="nav-link" href="/admin/goods/register2">커스터마이징 상품</a>
							</nav>
						</div>
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
						...
						</a> <a class="nav-link" href="/admin/goods/member">
							<div class="sb-nav-link-icon">
								<i class="fas fa-chart-area"></i>
							</div> 회원목록
			...
			<main>
				<div class="container-fluid px-4">
					...
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="index2">Dashboard</a></li>

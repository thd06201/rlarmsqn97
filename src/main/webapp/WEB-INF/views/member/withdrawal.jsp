               ...
               <div class="checkout-left">
                <div style="position: relative; right: -330px;" class="panel-group" id="accordion">	
                  <div class="panel-group" id="accordion">
                  	 ...
                  	 <a href="/"><div style="position: relative; right: -1100px;" > 홈 > 회원탈퇴</div><br></a>
                    ...
                    <input type="text" id="userName" name="userName" value="${member.userName}" /><hr>
               		...
               		<label for="userBi">생년월일 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <input type="text" id="userBi" name="userBi" value="${member.userBi}" /><hr>

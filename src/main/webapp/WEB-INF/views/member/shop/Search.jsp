          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <li>
                  <figure>
                    <a class="aa-product-img" href="/shop/productdetail?n=${product.gdsNum}">
                    <fmt:formatDate value="${product.gdsDate}" pattern="yyyy/MM/dd" var="datePath"/>	
                    	
                    <img src='<c:url value="/resources/imgUpload/${datePath }/${product.gdsImg}"/>'/></a>
                    
                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                    <figcaption>
                      <h4 class="aa-product-title"><a href="#">${product.gdsName}</a></h4>
                      <span class="aa-product-price">${product.gdsPrice}</span><span class="aa-product-price"></span>

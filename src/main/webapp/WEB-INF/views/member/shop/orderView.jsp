...
<!-- Cart view section -->
      <section id="cart-view">
         ...
         <div class="container">
            ...
            <a href="order.html"  style="background-color:#FF1493;"  class="aa-cart-view-btn col-md-6">주문 내역 조회(${orderListCount })</a> 
         </div>   
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="cart-view-area">
                     <div class="cart-view-table">
                        ...
                        <a href="/"  style="background-color:#FF1493;" class="aa-cart-view-btn col-md-2 col-md-pull-5">홈으로</a>

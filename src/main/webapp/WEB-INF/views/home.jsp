                 ...
                 <ul class="nav nav-tabs aa-products-tab">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      ...
                      <a class="aa-browse-btn"   style="background-color:#FF1493;" href="#">Browse all Product <span class="fa fa-long-arrow-right"></span></a>
                    </div>
          ...
          <div class="aa-testimonial-area">
            <ul class="aa-testimonial-slider">
              ...
              <li>
                ...
                <img class="aa-testimonial-img" src="/resources/img/testimonial-img-2.jpg" alt="testimonial img">
